...
//
//@Service
//public class UserServiceOrigImpl implements UserServiceOrig {
//
//    private static final Logger logger = LoggerFactory.getLogger(UserServiceOrigImpl.class);
//
