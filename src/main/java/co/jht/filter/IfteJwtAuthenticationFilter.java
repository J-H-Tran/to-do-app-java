...
import co.jht.service.impl.IfteJwtService;
...
@Component
public class IfteJwtAuthenticationFilter extends OncePerRequestFilter {

    private final IfteJwtService jwtService;
    private final UserDetailsServiceImpl userDetailsService;


    public IfteJwtAuthenticationFilter(IfteJwtService jwtService, UserDetailsServiceImpl userDetailsService) {
